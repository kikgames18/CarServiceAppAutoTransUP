...
namespace CarServiceApp.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Сопоставление свойств с колонками (если имена отличаются)
            ...
            modelBuilder.Entity<Request>(entity =>
            {
                ...
                entity.Property(r => r.CarType).HasColumnName("car_type");
                entity.Property(r => r.CarModel).HasColumnName("car_model");
                entity.Property(r => r.ProblemDescription).HasColumnName("problem_description");
                entity.Property(r => r.RequestStatus).HasColumnName("request_status");
                entity.Property(r => r.CompletionDate).HasColumnName("completion_date");
                entity.Property(r => r.RepairParts).HasColumnName("repair_parts");
                entity.Property(r => r.MasterID).HasColumnName("master_id");
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                ...
                entity.Property(c => c.MasterID).HasColumnName("master_id");
            ...
            modelBuilder.Entity<Request>()
                .HasOne(r => r.Client)
                .WithMany(u => u.ClientRequests)  // обратная связь в User
            ...
            modelBuilder.Entity<Request>()
                .HasOne(r => r.Master)
                .WithMany(u => u.MasterRequests)  // обратная связь в User
            ...
            modelBuilder.Entity<Comment>()
                .HasOne(c => c.Master)
                .WithMany(u => u.Comments)  // обратная связь в User
